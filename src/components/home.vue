        ...
        <div class="body">
            <div class="menu">
                <el-menu 
                    ...
                    :collapse="isCollapse">
                    <router-link to="/main/ai_demo/image_detect">
                        <el-menu-item index="image_detect">
                            <i class="fa fa-pie-chart m-r-10 icon-left" ></i>
                            <span slot="title">AI图片检测</span>
                        </el-menu-item>
                    </router-link>
                    <router-link to="/main/ai_demo/video_detect">
                        <el-menu-item index="video_detect">
