var GPS = {  
    ...
    //WGS-84 to BD-09  
    wbd_encrypt: function (wgsLat, wgsLng)  
    {  
        if (this.outOfChina(wgsLat, wgsLng))  
            return { 'lat': wgsLat, 'lng': wgsLng };  
    ...
    {  
        ...
        return { 'lat':  parseFloat(gcjLat) - parseFloat(d.lat), 'lng': (gcjLng) - parseFloat(d.lng) };  
    },  
    ...
    {  
        ...
        //console.log(i);  
        return { 'lat':  parseFloat(wgsLat), 'lng':  parseFloat(wgsLng) };  
    },  
    //GCJ-02 to BD-09  
    ...
    {  
        ...
        return { 'lat':  parseFloat(bdLat), 'lng':  parseFloat(bdLng) };  
    },  
    ...
    {  
        ...
        return { 'lat':  parseFloat(gcjLat), 'lng': parseFloat(gcjLng) };  
    },  
